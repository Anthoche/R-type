...
namespace scene {
	...
	void WaitingScene::init() {
		...
		game::entities::create_text(_registry, {40.f, 36.f}, statusText,
									Color{190, 255, 210, 255}, -0.5f, statusFontSize, _font);
		...
		game::entities::create_text(_registry, instructionsPos, instructions,
									Color{200, 245, 210, 255}, -0.5f, instructionsFontSize, _font);
		...
		game::entities::create_button(_registry, "button_ready", joinText,
									 ...
									 accentColor, BLACK, buttonFontSize);
		...
		Color secondaryColor = Color{29, 143, 90, 255};
		Color arrowTextColor = Color{230, 255, 240, 255};
