...
void GameScene::initialize() {
	...
	game::entities::setup_player_bounds_system(_registry, static_cast<float>(_window_width), static_cast<float>(_window_height));
...
void GameScene::create_enemies() {
	...
	_registry.emplace_component<component::position>(enemy, static_cast<float>(_window_width - 50), y_dist(gen));
	...
	drawable.r = 1.f; drawable.g = 0.f; drawable.b = 0.f; drawable.a = 1.f; // Rouge
...
void GameScene::create_obstacles() {
	for (int i = 0; i < 3; ++i) {
		...
		drawable.r = 0.4f; drawable.g = 0.4f; drawable.b = 0.4f; drawable.a = 1.f; // Gris
