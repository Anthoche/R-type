...
namespace game::entities {
    ...
    ecs::entity_t create_enemy(ecs::registry &reg, float x = 900.f, float y = 300.f,
        float z = 0.f, const std::string &imagePath = "", float width = 0.0f, float height = 0.0f, const std::string &modelPath = "",
        const std::string &pattern = "", int healthValue = 3, float velocity = -1.f);
