...
class SettingsScene : public AScene {
    ...
    private:
        ...
        */
        ...
        /**
        * @brief Setup all scene elements (title, buttons, back button).
        */
        void setupScene();
        ...
        */
        ...
        /**
        * @brief Create the scene title text entity.
        */
        void createTitle();

        /**
        * @brief Create all main buttons and option texts.
        */
        void createButtons();

        /**
        * @brief Create the back button entity.
        */
        void createBackButton();

        /**
        * @brief Type alias for a pointer to a member function used for button creation.
        */
        ...
        */
        ...
        /**
        * @brief Toggle the sound option between On and Off.
        */
        void toggleSound();

        /**
        * @brief Cycle through the available lives options.
        */
        void cycleLives();
        ...
        * @param newText The new text content for the button.
        */
