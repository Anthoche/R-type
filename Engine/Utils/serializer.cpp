    ...
    void deserialize_entities(ecs::registry &reg, const nlohmann::json &j)
    {
        try {
            ...
            for (const auto &entity_data : entities_json) {
                ...
                switch (type_enum) {
                    case component::entity_type::PLAYER: game::parsing::parse_player(reg, entity_data); break;
                    case component::entity_type::ENEMY: game::parsing::parse_enemy(reg, entity_data); break;
                    case component::entity_type::OBSTACLE: game::parsing::parse_obstacle(reg, entity_data); break;
                    case component::entity_type::BACKGROUND: game::parsing::parse_background(reg, entity_data); break;
                    case component::entity_type::RANDOM_ELEMENT: game::parsing::parse_random_element(reg, entity_data); break;
                    case component::entity_type::SOUND: game::parsing::parse_sound(reg, entity_data); break;
                    case component::entity_type::TEXT: game::parsing::parse_text(reg, entity_data); break;
                    case component::entity_type::ITEM: game::parsing::parse_item(reg, entity_data); break;
                    case component::entity_type::POWERUP: game::parsing::parse_powerup(reg, entity_data); break;
                    case component::entity_type::TRAP: game::parsing::parse_trap(reg, entity_data); break;
                    case component::entity_type::GATE: game::parsing::parse_gate(reg, entity_data); break;
                    case component::entity_type::WEAPON: game::parsing::parse_weapon(reg, entity_data); break;
                    case component::entity_type::PLATFORM: game::parsing::parse_platform(reg, entity_data); break;
                    case component::entity_type::DECORATION: game::parsing::parse_decoration(reg, entity_data); break;
